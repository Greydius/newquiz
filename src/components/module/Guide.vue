<template>
  <div class="module-guide">
    <h2>Блок заданий (25 вопросов – 38 минут):</h2>
    <p>
      ...
      <br>
      Для начала выполнения заданий нажмите кнопку «Начать», для перехода к следующему вопросу нажмите кнопку «Далее», для возврата к предыдущему вопросу нажмите кнопку «Назад» либо кнопку с указанием номера вопроса. Чтобы завершить задание, нажмите кнопку «Завершить».
    </p>
